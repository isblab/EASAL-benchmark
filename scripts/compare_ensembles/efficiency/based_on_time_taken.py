...
for case in input_cases:
    if 'DSSO' in case and len(case) <15:
        file1 = '~/easal/results/imp_output/without_fp/DSSO/'+case.split('DSSO')[0] + case.split('_')[-1]+ '/run_1/stat_replica.0.out'
        file2 = '~/easal/results/imp_output/without_fp/DSSO/'+case.split('DSSO')[0] + case.split('_')[-1]+ '/run_1/initial.0.rmf3'

    elif 'DSSO' in case and len(case) >15:
        file1 = '~/easal/results/imp_output/without_fp/DSSO/'+case.split('_DSSO')[0] + '/run_1/stat_replica.0.out'
        file2 = '~/easal/results/imp_output/without_fp/DSSO/'+case.split('_DSSO')[0] + '/run_1/initial.0.rmf3'

    elif 'DMTMM' in case:
        file1 = '~/easal/results/imp_output/without_fp/DMTMM/'+case.split('DMTMM')[0] + case.split('_')[-1]+ '/run_1/stat_replica.0.out'
        file2 = '~/easal/results/imp_output/without_fp/DMTMM/'+case.split('DMTMM')[0] + case.split('_')[-1]+ '/run_1/initial.0.rmf3'
...
plt.tight_layout()
# plt.show()
plt.savefig('~/easal/results/plots/time_related/F10.runtime.png',dpi=600)
...
plt.tight_layout()
# plt.show()
plt.savefig('~/easal/results/plots/time_related/F10.runtime_per_run.png',dpi=600)
